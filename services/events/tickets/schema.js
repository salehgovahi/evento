...
const registration = {
    registerSchema: Joi.object().keys({
        ...
        educational_status: Joi.string().required().messages({
            'string.base': 'وضعیت تحصیلی باید یک رشته معتبر باشد',
            'any.required': 'وارد کردن وضعیت تحصیلی الزامی است'
        }),
        ...
        educational_level: Joi.number().integer().required().messages({
            'number.base': 'سطح تحصیلی باید یک عدد معتبر باشد',
            'any.required': 'وارد کردن سطح تحصیلی الزامی است',
            'number.integer': 'سطح تحصیلی باید یک عدد صحیح باشد'
        }),
        field_of_study: Joi.number().integer().required().messages({
            'number.base': 'رشته تحصیلی باید یک عدد معتبر باشد',
            'any.required': 'وارد کردن رشته تحصیلی الزامی است',
        ...
        institution_name: Joi.string().required().messages({
            ...
            'any.required': 'وارد کردن نام مؤسسه الزامی است'
        }),
